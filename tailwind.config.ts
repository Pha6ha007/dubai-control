    ...
    extend: {
      colors: {
        ...
        analytics: {
          ...
          "primary-light": "hsl(var(--analytics-primary-light))",
          success: "hsl(var(--analytics-success))",
          "success-light": "hsl(var(--analytics-success-light))",
          warning: "hsl(var(--analytics-warning))",
          "warning-light": "hsl(var(--analytics-warning-light))",
          danger: "hsl(var(--analytics-danger))",
          "danger-light": "hsl(var(--analytics-danger-light))",
          neutral: "hsl(var(--analytics-neutral))",
          "neutral-light": "hsl(var(--analytics-neutral-light))",
          accent: "hsl(var(--analytics-accent))",
          "accent-light": "hsl(var(--analytics-accent-light))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
