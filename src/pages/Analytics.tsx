...
import { kpiData, trendData, cleanerPerformance } from '@/data/analyticsData';
      ...
      <div className="mx-auto max-w-7xl px-6 py-8">
        ...
        <section className="mb-10">
          <div className="mb-6">
            ...
            <p className="text-sm text-muted-foreground">Job completion and performance over time</p>
          </div>
        ...
        <section>
          <div className="mb-6">
            <h2 className="text-lg font-semibold text-foreground">Performance Breakdown</h2>
            <p className="text-sm text-muted-foreground">Cleaner metrics and comparison</p>
          </div>
