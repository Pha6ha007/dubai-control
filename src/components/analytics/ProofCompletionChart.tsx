...
export function ProofCompletionChart({ data }: ProofCompletionChartProps) {
  return (
    <div className="rounded-xl border border-border bg-card p-6 shadow-card">
      <div className="mb-6">
        <h3 className="text-base font-semibold text-foreground">Proof Completion Trend</h3>
        <p className="text-sm text-muted-foreground">Before photo, after photo, and checklist completion rates</p>
      </div>
