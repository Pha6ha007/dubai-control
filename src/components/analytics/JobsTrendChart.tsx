...
export function JobsTrendChart({ data }: JobsTrendChartProps) {
  return (
    <div className="rounded-xl border border-border bg-card p-6 shadow-card">
      <div className="mb-6">
        <h3 className="text-base font-semibold text-foreground">Jobs Completed</h3>
        <p className="text-sm text-muted-foreground">Daily job completion over the last 14 days</p>
      </div>
